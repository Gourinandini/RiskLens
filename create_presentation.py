...
with PdfPages(pdf_path) as pdf:
    ...
    ax.text(50, 28, "Developed by: Gourinandini", fontsize=12, 
            color=TEXT_COLOR, fontfamily='sans-serif', ha='center')
    ...
    ax.text(7, 73, problem_text, fontsize=10, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.6, va='top')
    ...
    ax.text(53, 73, solution_text, fontsize=10, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.6, va='top')
    ...
    ax.text(7, 75, metrics_text, fontsize=11, color=TEXT_COLOR, 
            fontfamily='monospace', fontweight='bold', linespacing=1.5, va='top')
    ...
    ax.text(7, 39, imbalance_text, fontsize=9.5, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.4, va='top')
    ...
    ax.text(7, 75, xai_text, fontsize=9.5, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.5, va='top')
    ...
    ax.text(53, 75, rules_text, fontsize=9.5, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.4, va='top')
    ...
    ax.text(7, 75, copilot_text, fontsize=9.5, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.5, va='top')
    ...
    ax.text(53, 75, patterns_text, fontsize=8.5, color=TEXT_COLOR, 
            fontfamily='sans-serif', linespacing=1.3, va='top')
