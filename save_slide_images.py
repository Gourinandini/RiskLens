...
Saves slide images to ./documents/slide1.png to slide6.png.
"""
import os
import matplotlib
...
ax.text(50, 28, "Developed by: Gourinandini", fontsize=12, color=TITLE_COLOR, fontfamily='sans-serif', ha='center')
